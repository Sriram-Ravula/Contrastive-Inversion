...
class ImageNetCLIPDataset(LightningDataModule):
    ...
    def __init__(self, args):
        ...
        if self.hparams.distortion == "None":
            self.train_set_transform = ImageNetBaseTrainContrastiveDecoupled(self.hparams)
...
def run_noisy_clip():
    ...
    dataset.setup()
    model = NoisyCLIP.load_from_checkpoint('Logs_RN101_Adam/clean_st/checkpoints/epoch=24-step=12374.ckpt')
